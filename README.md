...
``` bash
curl -s https://raw.githubusercontent.com/tarmeez-sa/odoo-18-docker-compose/main/run.sh | sudo bash -s odoo-one 10018 20018
```
and/or run the following to set up another Odoo instance @ `localhost:11018` (default master password: `tarmeez-sa`):

``` bash
curl -s https://raw.githubusercontent.com/tarmeez-sa/odoo-18-docker-compose/main/run.sh | sudo bash -s odoo-two 11018 21018
```
